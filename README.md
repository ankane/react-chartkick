...
```jsx
<LineChart data={{"2026-01-01": 11, "2026-01-02": 6}} />
```
...
```jsx
<AreaChart data={{"2026-01-01": 11, "2026-01-02": 6}} />
```
...
```jsx
<LineChart data={[["2026-01-01", 2], ["2026-01-02", 3]]} />
```
...
```jsx
<LineChart xmin="2026-01-01" xmax="2026-02-01" />
```
